...
class ObjectDataset(utils.Dataset):
    ...
    def load_object(self, dataset_dir, subset):
        ...
        self.add_class(ObjectConfig().NAME, 1, "flip")
        self.add_class(ObjectConfig().NAME, 2, "flop")
        ...
        for a in annotations:
            ...
            num_ids = [int(n[ObjectConfig().NAME]) for n in objects]
            ...
            self.add_image(ObjectConfig().NAME,
                           image_id=a['filename'],
                           path=image_path,
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if info["source"] != ObjectConfig().NAME:
